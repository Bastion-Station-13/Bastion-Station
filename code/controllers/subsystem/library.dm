...
SUBSYSTEM_DEF(library)
	...
	var/list/search_categories = list("Any", "Fiction", "Non-Fiction", "Poetry", "Reference", "Religion")
	/// List of acceptable categories for a book to be
	var/list/upload_categories = list("Fiction", "Non-Fiction", "Poetry", "Reference", "Religion")
