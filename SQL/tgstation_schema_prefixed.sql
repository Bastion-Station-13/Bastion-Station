...
CREATE TABLE `SS13_library` (
  ...
  `category` enum('Any','Fiction','Non-Fiction','Poetry','Reference','Religion') NOT NULL,
...
DROP PROCEDURE IF EXISTS `SS13_set_poll_deleted`;
DROP TRIGGER IF EXISTS `SS13_role_timeTlogupdate`;
DROP TRIGGER IF EXISTS `SS13_role_timeTloginsert`;
DROP TRIGGER IF EXISTS `SS13_role_timeTlogdelete`;
DELIMITER $$
...
--
-- Table structure for table `SS13_text_adventures`
--
